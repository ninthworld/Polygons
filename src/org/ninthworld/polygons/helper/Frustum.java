...
/**
 * Created by NinthWorld on 4/19/2017.
 */
public class Frustum {
    ...
    public static Frustum getFrustum(Matrix4f proj, Matrix4f view) {
        frustum.calculateFrustum(proj, view);
        return frustum;
    }
    ...
    private void calculateFrustum(Matrix4f proj, Matrix4f view) {
        this._proj.clear();
        this._modl.clear();
        this._clip.clear();

//        GL11.glGetFloat(2983, this._proj);
        proj.store(this._proj);
//
